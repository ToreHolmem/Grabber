...
# This script is called "Download_Aerial_1km.py" and is used to download aerial imagery data for a 1 km x 1 km bounding box.
...
zoom_level = 14  # or another value as required
