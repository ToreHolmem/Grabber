...
zoom_level = 5  # Set your desired zoom level
...
output_image_path = os.path.join(args.output_location, 'aerial_60km_download.tif')
...
print("Aerial 60km download and stitch done")
